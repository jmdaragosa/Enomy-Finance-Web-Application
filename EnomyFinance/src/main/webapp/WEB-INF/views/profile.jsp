...
<head>
    <meta charset="UTF-8">
    <title>User Profile - User View | Enomy Finance</title>
...
<body>
    ...
    <div class="container mt-4">
        ...
        <p><strong>Balance:</strong> £<fmt:formatNumber value="${user.balance}" type="number" minFractionDigits="2" /></p>
        ...
        <c:choose>
                    ...
                    <tbody>
                        <c:forEach var="quote" items="${currencyQuotes}">
                            <tr>
                                ...
                                <td>$<fmt:formatNumber value="${quote.originalAmount}" type="number" minFractionDigits="2" /></td>
                                <td>$<fmt:formatNumber value="${quote.convertedAmount}" type="number" minFractionDigits="2" /></td>
                                <td>${quote.exchangeRate}</td>
                                <td>$<fmt:formatNumber value="${quote.fee}" type="number" minFractionDigits="2" /></td>
                            </tr>
                        </c:forEach>
                    </tbody>
                </table>
            ...
            <c:otherwise>
                <p class="text-muted">No saved currency conversions found for this user.</p>
            </c:otherwise>
        </c:choose>
